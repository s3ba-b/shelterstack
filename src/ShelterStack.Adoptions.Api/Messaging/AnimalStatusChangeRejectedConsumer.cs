...
/// <summary>
/// Subscribes to <see cref="AnimalStatusChangeRejected"/> and hands each message to
/// <see cref="AnimalStatusChangeRejectedHandler"/>.
/// <para>
...
/// </para>
/// </summary>
public sealed class AnimalStatusChangeRejectedConsumer(
    IServiceProvider services,
    ILogger<AnimalStatusChangeRejectedConsumer> logger
) : BackgroundService
{
    ...
    public const string QueueName = "adoptions-api.animal-status-change-rejected";
    ...
    private async Task OnReceivedAsync(object sender, BasicDeliverEventArgs args)
    {
        ...
        {
            var message =
                JsonSerializer.Deserialize<AnimalStatusChangeRejected>(
                    args.Body.Span,
            ...
            await scope
                .ServiceProvider.GetRequiredService<AnimalStatusChangeRejectedHandler>()
